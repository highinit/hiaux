...
CxxTest::StaticSuiteDescription suiteDescription_HwordTests( "hword_tests.h", 23, "HwordTests", suite_HwordTests, Tests_HwordTests );

static class TestDescription_suite_HwordTests_testSimple : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_HwordTests_testSimple() : CxxTest::RealTestDescription( Tests_HwordTests, suiteDescription_HwordTests, 61, "testSimple" ) {}
...
public:
 TestDescription_suite_HwordTests_testDistributed() : CxxTest::RealTestDescription( Tests_HwordTests, suiteDescription_HwordTests, 89, "testDistributed" ) {}
...
public:
 TestDescription_suite_HwordTests_testMongoDbAccessor() : CxxTest::RealTestDescription( Tests_HwordTests, suiteDescription_HwordTests, 132, "testMongoDbAccessor" ) {}
...
public:
 TestDescription_suite_HwordTests_testDistributedWithDb() : CxxTest::RealTestDescription( Tests_HwordTests, suiteDescription_HwordTests, 170, "testDistributedWithDb" ) {}
